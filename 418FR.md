...
**2.** Did you work with a group? If so, include the names of your other
group members here.
...
*Reflect:* Most of these objectives are fulfilled by the final project;
particularly objectives 1, 2, 4, and 5.
...
get me, *cough cough*, back ticks). See the “CLEAN DATA” section of the
project rmd file (**would you rather I rewrote these code chunks in here
instead of referencing the areas/chunks of project?**). In these chunks
I removed unwanted rows/cols, renamed variables, and converted some
variable types. filter(!is.na()) is my bff.
