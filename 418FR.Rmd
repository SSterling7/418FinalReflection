...
- Box plots. I really liked this visualization. This is comparing the mean GPAs of the different major categories. I liked to mess with different options here -
...
- mosaic plots. These seem super fun for categorical variables and it wasn't something I was aware of previously. It's like a plot version of a contingency table. You can have multiple variabels being compared as well (not just 2). I also used labs; here I can set titles, axis, and legend labels.
